...
{ 
    ...
    char first_word, first_word_typing[] = "DongEui University!";    // 연습할 텍스트
    char second_word, second_word_typing[] = "I'm a student."; 
    char third_word, third_word_typing[] = "This is the lab3."; 
    ...
    { 
        if (first_word == first_word_typing[first_word_count++]) 
        { 
    ...
    { 
        if (second_word == second_word_typing[second_word_count++]) 
        { 
    ...
    { 
        if (third_word == third_word_typing[third_word_count++]) 
        { 
    ...
    printf("\n\n오타 횟수는 %d\n", total_error); 
    time(&time2); 
    result(time1, time2, first_word_typing, second_word_typing, third_word_typing, total_error); 
